...
# NEAR_ENV=testnet near call $KATHERINE_CONTRACT_ADDRESS create_sale \
#     '{"slug": "dev-sale-near-4p", "is_in_near": true, "sold_token_contract_address": "'$PTOKEN_CONTRACT_ADDRESS'", "one_payment_token_purchase_rate": "6'$YOCTO_UNITS'", "max_available_sold_token": "6000'$YOCTO_UNITS'", "open_date_timestamp": "'$SALE_3_OPEN_DATE'", "close_date_timestamp": "'$SALE_3_CLOSE_DATE'", "release_date_timestamp": "'$SALE_3_RELEASE_DATE'"}' \
#     --accountId $NEAR_ACCOUNT \
#     --gas $TOTAL_PREPAID_GAS \
#     --depositYocto $SALE_CREATION_COST

# NEAR_ENV=testnet near call $KATHERINE_CONTRACT_ADDRESS create_sale \
#     '{"slug": "dev-sale-near-5p", "is_in_near": false, "sold_token_contract_address": "'$PTOKEN_CONTRACT_ADDRESS'", "one_payment_token_purchase_rate": "7'$YOCTO_UNITS'", "max_available_sold_token": "700'$YOCTO_UNITS'", "open_date_timestamp": "'$SALE_3_OPEN_DATE'", "close_date_timestamp": "'$SALE_3_CLOSE_DATE'", "release_date_timestamp": "'$SALE_3_RELEASE_DATE'"}' \
#     --accountId $NEAR_ACCOUNT \
#     --gas $TOTAL_PREPAID_GAS \
#     --depositYocto $SALE_CREATION_COST
...
NEAR_ENV=testnet near view $KATHERINE_CONTRACT_ADDRESS get_sales '{"from_index": 0, "limit": 10}'
